...
<form action="?" method="post">
    ...
    <p>
    <h3>Output:</h3>
    <img src="show.php?char=<?php echo urlencode($char); ?>&size=128&cache=<?php echo mt_rand(1, 65536); ?>">
    <img src="show.php?char=<?php echo urlencode($char); ?>&size=64&cache=<?php echo mt_rand(1, 65536); ?>">
    <img src="show.php?char=<?php echo urlencode($char); ?>&size=64&cache=<?php echo mt_rand(1, 65536); ?>">
    <img src="show.php?char=<?php echo urlencode($char); ?>&size=64&cache=<?php echo mt_rand(1, 65536); ?>">
    <img src="show.php?char=<?php echo urlencode($char); ?>&size=32&cache=<?php echo mt_rand(1, 65536); ?>">
    </p>
    <?php
